...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "KC Earn — African Social Video Platform" },
      {
        name: "description",
        content:
          "KC Earn is a mobile-first African social video platform to share videos and discover creators.",
      },
      { property: "og:title", content: "KC Earn — African Social Video Platform" },
      {
        property: "og:description",
        content: "Share videos and discover African creators on KC Earn.",
      },
